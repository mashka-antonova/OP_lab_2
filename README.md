...
кнопку для выбора открываемого файла (fileDialog) и поле для вывода его
названия;
таблицу, при помощи которой будут визуализироваться данные;
поле для ввода названия региона;
поле для ввода номера колонки;
кнопку "Load data";
кнопку "Calculate metrics";
поля для вывода статистических метрик.
...
Строка csv файла должна быть преобразована в структуру сразу после считывания. Структуры необходимо сохранить в самостоятельно реализованную динамическую структуру данных.
...
Обход динамической структуры данных должен осуществляться при помощи итератора.
